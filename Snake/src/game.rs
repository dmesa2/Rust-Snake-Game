...
impl Game {
    ...
    pub fn new(theme: Color, width: i32, height: i32, player_shift: i32) -> Game {
    ...
    fn check_if_snake_alive(&self, dir: Option<Direction>) -> bool {
        ...
        if self.snake.overlap_tail(self.obs_x + 1, self.obs_y) {
            //if snake runs into obstacle
            music::play_sound(
                &SoundEffect::Die,
                music::Repeat::Times(0),
        ...
        if self.snake.overlap_tail(self.obs_x, self.obs_y + 1) {
            //if snake runs into obstacle
            music::play_sound(
                &SoundEffect::Die,
                music::Repeat::Times(0),
        ...
        if self.snake.overlap_tail(self.obs_x + 1, self.obs_y + 1) {
            //if snake runs into obstacle
            music::play_sound(
                &SoundEffect::Die,
                music::Repeat::Times(0),
    ...
    fn restart(&mut self) {
        ...
        self.food_x = 6 + self.origin_x; //food will start here
        self.food_y = 4; //food will start here
        self.food_type = "apple".to_string();
        self.obs_x = 25 + self.origin_x;
        self.obs_y = 5;
