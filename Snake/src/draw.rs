...
pub fn to_coord(game_coord: i32) -> f64 {//Take in a coord and then cast it as f64 then mult by block size
...
pub fn draw_block(color: Color, x: i32, y: i32, con: &Context, g: &mut G2d) {//Helper func - Draw a block
...
pub fn draw_rectangle(//allows us to draw rectangles
